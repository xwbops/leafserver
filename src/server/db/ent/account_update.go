...
func (au *AccountUpdate) SetSalt(s string) *AccountUpdate {
	au.mutation.SetSalt(s)
	return au
}

// SetNillableSalt sets the "salt" field if the given value is not nil.
func (au *AccountUpdate) SetNillableSalt(s *string) *AccountUpdate {
	if s != nil {
		au.SetSalt(*s)
	}
	return au
...
// SetSalt sets the "salt" field.
func (auo *AccountUpdateOne) SetSalt(s string) *AccountUpdateOne {
	auo.mutation.SetSalt(s)
	return auo
}

// SetNillableSalt sets the "salt" field if the given value is not nil.
func (auo *AccountUpdateOne) SetNillableSalt(s *string) *AccountUpdateOne {
	if s != nil {
		auo.SetSalt(*s)
	}
	return auo
